...
Gem::Specification.new do |s|
  ...
  s.authors = ["Konstantin Haase".freeze, "Hiro Asari".freeze, "Henrik Hodne".freeze, "joshua-anderson".freeze, "Aaron Hill".freeze, "Peter Souter".freeze, "Christopher Grim".freeze, "Joe Corcoran".freeze, "Peter van Dijk".freeze, "Max Barnash".freeze, "Dan Buch".freeze, "Mathias Meyer".freeze, "carlad".freeze, "Carlos Palhares".freeze, "Ren\u{e9}e Hendricksen".freeze, "David Rodr\u{ed}guez".freeze, "Corinna Wiesner".freeze, "Stefan Nordhausen".freeze, "Thais Camilo and Konstantin Haase".freeze, "Andreas Tiefenthaler".freeze, "Matthias Bussonnier".freeze, "Michael Mior".freeze, "Miro Hron\u{10d}ok".freeze, "Neamar".freeze, "Nicolas Bessi (nbessi)".freeze, "Peter Bengtsson".freeze, "Piotr Sarnacki".freeze, "Rapha\u{eb}l Pinson".freeze, "Rob Hoelz".freeze, "Robert Van Voorhees".freeze, "Zachary Gershman".freeze, "Zachary Scott".freeze, "jeffdh".freeze, "john muhl".freeze, "Tobias Wilken".freeze, "Adam Lavin".freeze, "Adrien Brault".freeze, "Basarat Ali Syed".freeze, "Benjamin Manns".freeze, "Daniel Chatfield".freeze, "Eric Herot".freeze, "George Millo".freeze, "Jacob Atzen".freeze, "Jacob Burkhart".freeze, "Joe Rafaniello".freeze, "Jon-Erik Schneiderhan".freeze, "Jonas Chromik".freeze, "Jonne Ha\u{df}".freeze, "Josh Kalderimis".freeze, "Julia S.Simon".freeze, "Justin Lambert".freeze, "Laurent Petit".freeze, "Maarten van Vliet".freeze, "Mario Visic".freeze]
  s.date = "2017-01-26"
