...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--enable-shared' '--disable-install-doc' 'debugflags=-g' 'CPPFLAGS=-DFD_SETSIZE=2048' '--host=x86_64-w64-mingw32' '--prefix=' 'host_alias=x86_64-w64-mingw32' 'LDFLAGS='"
